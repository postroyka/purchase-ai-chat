...
> (`B24_BOT_DEBUG`, по умолчанию вкл; логирует только `PARAMS`, без токенов) — снять на первом прогоне и
> при необходимости поправить `resolveDownloadUrl` в `b24-bot-api.js`.
