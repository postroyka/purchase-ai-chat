...
// `perf` (#279) — agent-only: диагностика скорости НА КАЖДОМ файле (агент сам сообщает, что замедлило,
// либо «штатно»). В GitHub issue не идёт — метрика + лог + показ оператору в UI (#294).
