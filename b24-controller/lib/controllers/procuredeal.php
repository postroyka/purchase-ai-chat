	...
	): ?array
	{
		...
		foreach($items as $item)
		{
			...
			$productRows[] = [
				...
				// портале (настройка «цены содержат НДС») вариант N давал неверный итог: B24 не добавлял
				// 20% сверху, а «вытаскивал» НДС изнутри, занижая сумму сделки. Возвращаем Y для повторного
				// теста; финальную модель НДС выбираем по итогам проверки.
				'TAX_INCLUDED' => 'Y',
