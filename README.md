...
- [docs/USER_GUIDE.md](docs/USER_GUIDE.md) — **руководство**: сотруднику (как загрузить счёт и прочитать результат), владельцу/админу (чек-лист запуска + как растить точность по `/metrics`)
