...
describe('b24_task_start', () => {
  ...
  it('calls actions.v2.call.make with tasks.task.start and returns the started-task summary', async () => {
    fake.v2Call.mockResolvedValue(fakeOk({ task: { id: 8017, title: 'do it', status: '3', responsibleId: '503' } }))
