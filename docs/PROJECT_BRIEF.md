...
**Открытые задачи (issues):** #182 (срочно — сбор фидбека от пользователя/MCP/агента) · #176 (автозавод кастом-полей при установке) · #177 (рус. форма входа, нужна только вне B24) · #174/#175 (харднинг). _(PR в полёте: #183 этот · #181 rename CI · #184 долги недели 3.)_
